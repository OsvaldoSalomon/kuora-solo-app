...
module.exports = {
	up: (queryInterface, Sequelize) => {
		return queryInterface.bulkInsert(
			...
			[
				{
					answer: `Because just like in the comics, Mr. Knight has the powers of Moon Knight but
				...
				{
					answer: `I don't know about Sith Lord, but we know when Palpatine really began to take an interest in Anakin.
				...
				{
					answer: `Qui-Gon learned the ability to become a Force ghost from the Shaman of the Whills.
				...
				{
					answer: `Since, The Ancient One was Sorcerer Supreme, the contest would have been tough.
